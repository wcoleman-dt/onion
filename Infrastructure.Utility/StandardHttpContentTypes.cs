...
{
    public static class StandardHttpContentTypes
    {
        ...
        public static readonly string ApplicationXJavascript = "application/x-javascript";
        ...
        public static readonly string ApplicationXShockwaveFlash = "application/x-shockwave-flash";
        ...
        public static readonly string TextCmd = "text/cmd";
        ...
        public static readonly string ApplicationXDeb = "application/x-deb";
        ...
        public static readonly string ApplicationXDvi = "application/x-dvi";
        ...
        public static readonly string VideoXFlv = "video/x-flv";
        ...
        public static readonly string TextXGwtRpc = "text/x-gwt-rpc";
        ...
        public static readonly string MessageImdnXml = "message/imdn+xml";

        ///<summary>JavaScript Object Notation JSON; Defined in RFC 4627</summary>
        public static readonly string ApplicationJson = "application/json";

        ///<summary>JavaScript Object Notation (JSON) Patch; Defined in RFC 6902</summary>
        public static readonly string ApplicationJsonPatch = "application/json-patch+json";
        ...
        [Obsolete]
        public static readonly string TextJavascript = "text/javascript";
        ...
        public static readonly string TextXJqueryTmpl = "text/x-jquery-tmpl";
        ...
        public static readonly string ApplicationXLatex = "application/x-latex";

        ///<summary>Matroska open media format</summary>
        public static readonly string VideoXMatroska = "video/x-matroska";

        ///<summary>Microsoft Excel 2007 files</summary>
        public static readonly string ApplicationVndOpenxmlformatsOfficedocumentSpreadsheetmlSheet = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
        ...
        public static readonly string ApplicationVndOpenxmlformatsOfficedocumentPresentationmlPresentation = "application/vnd.openxmlformats-officedocument.presentationml.presentation";
        ...
        public static readonly string ApplicationVndOpenxmlformatsOfficedocumentWordprocessingmlDocument = "application/vnd.openxmlformats-officedocument.wordprocessingml.document";
        ...
        public static readonly string VideoOgg = "video/ogg";

        ///<summary>Ogg Vorbis, Speex, Flac and other audio; Defined in RFC 5334</summary>
        public static readonly string AudioOgg = "audio/ogg";
        ...
        public static readonly string ApplicationXPkcs12 = "application/x-pkcs12";

        ///<summary>p7b and spc files</summary>
        public static readonly string ApplicationXPkcs7Certificates = "application/x-pkcs7-certificates";

        ///<summary>p7c files</summary>
        public static readonly string ApplicationXPkcs7Mime = "application/x-pkcs7-mime";

        ///<summary>p7r files</summary>
        public static readonly string ApplicationXPkcs7Certreqresp = "application/x-pkcs7-certreqresp";

        ///<summary>p7s files</summary>
        public static readonly string ApplicationXPkcs7Signature = "application/x-pkcs7-signature";
        ...
        public static readonly string ApplicationXRarCompressed = "application/x-rar-compressed";

        ///<summary>RealAudio; Documented in RealPlayer Customer Support Answer 2559</summary>
        public static readonly string AudioVndRnRealaudio = "audio/vnd.rn-realaudio";
        ...
        public static readonly string ApplicationRssXml = "application/rss+xml";
        ...
        public static readonly string ApplicationXStuffit = "application/x-stuffit";

        ///<summary>SVG vector image; Defined in SVG Tiny 1.2 Specification Appendix M</summary>
        public static readonly string ImageSvgXml = "image/svg+xml";
        ...
        public static readonly string ApplicationXTar = "application/x-tar";
